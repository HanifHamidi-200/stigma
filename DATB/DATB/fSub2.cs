...
namespace DATB
{
    public partial class fSub2 : Form
    {
        ...
        private int mnCount;
        private List<String> _colname1 = new List<String> { "nIndex", "sPileup", "sPush" };
        private List<String> _colname2 = new List<String> { "nIndex", "sPileup", "sPush" };
        private List<String> _colname3 = new List<String> { "nIndex", "sPileup", "sPush" };
        private List<String> _colname4 = new List<String> { "nIndex", "sPileup", "sPush" };
        ...
        private void lstDatabase_SelectedIndexChanged_1(object sender, EventArgs e)
        {
