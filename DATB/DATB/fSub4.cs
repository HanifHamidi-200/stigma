...
namespace DATB
{
    public partial class fSub4 : Form
    {
        ...
        private int mnCount;
        private List<String> _colname1 = new List<String> { "nID", "sDescription" };
        private List<String> _colname2 = new List<String> { "hTitle", "bFinding", "bLearnings" };
        private List<int> _count = new List<int> { 0, 0};
